<div class="space-y-6">
    ...
    <form @submit.prevent="uploadMedicalRecords" class="space-y-6">
        ...
        <div>
            ...
            <input type="date" x-model="form.destroy_date" 
                placeholder="yyyy-mm-dd"
                class="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-red-500 focus:ring-red-500" 
                required>
            <p class="text-xs text-gray-500 mt-2">
                <span class="text-gray-400">(yyyy-mm-dd)</span> A future date which these records will be automatically destroyed and no longer available.
            </p>
        </div>
        ...
        <div class="flex items-start gap-3 pt-4 border-t">
            ...
            <label for="acknowledge" class="text-sm text-gray-700">
                I understand that by submitting this form any existing medical records for the selected event will be deleted.
            </label>
        </div>
